...
const DevelopmentProcess = () => {
  ...
  const processes = [{
    ...
    description: "Сокращаем время переналадки оборудования — больше времени на производство, меньше простоев.",
    steps: ["Анализ текущих переналадок и хронометраж", "Разделение внешних и внутренних операций", "Стандартизация инструментов и процедур", "Обучение операторов и контроль результатов"]
  }, {
    id: 7,
    title: "TPM / Автономное обслуживание",
    description: "Операторы сами ухаживают за оборудованием — меньше поломок, выше OEE.",
    steps: ["Обучение операторов базовому обслуживанию", "Создание чек-листов и регламентов", "Система предиктивного обслуживания", "Измерение OEE и анализ потерь"]
  }, {
    id: 8,
    title: "Poka-Yoke / Защита от ошибок",
    description: "Встраиваем защиту от ошибок в процесс — невозможно сделать неправильно.",
    steps: ["Анализ типичных ошибок и их причин", "Разработка простых защитных механизмов", "Внедрение сигнализации и блокировок", "Валидация эффективности решений"]
  }, {
    id: 9,
    title: "Стандартная работа / SOP",
    description: "Лучший способ работы становится стандартом — стабильное качество и время цикла.",
    steps: ["Определение лучших практик и времени цикла", "Создание визуальных инструкций", "Обучение и сертификация персонала", "Аудиты соблюдения и улучшения"]
  }, {
    id: 10,
    title: "Хосин Канри / Развертывание политики",
    description: "Стратегия компании доходит до каждого рабочего места через цели и KPI.",
    steps: ["Каскадирование стратегических целей", "Создание A3-планов по уровням", "Ритм управленческих встреч", "Система отчетности и корректировок"]
  }, {
    id: 11,
    title: "Гемба-управление / Go & See",
    description: "Руководители регулярно идут туда, где создается ценность — решения на основе фактов.",
    steps: ["Обучение лидеров принципам гемба-обходов", "Создание стандартных маршрутов и чек-листов", "Система фиксации проблем и решений", "Еженедельные улучшения на основе наблюдений"]
  }];
  useEffect(() => {
      ...
      <section className="pt-24 pb-16">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl font-bold mb-8">Что f(Am)team сделает для вашего бизнеса</h1>
