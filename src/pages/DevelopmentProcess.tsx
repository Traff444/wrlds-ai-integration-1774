...
const DevelopmentProcess = () => {
  ...
  const processes = [{
    ...
    id: 6,
    title: "Стандартизация работы",
    description: "Стандартизируем ключевые операции. Единственный лучший способ выполнения — предсказуемое качество в каждой смене.",
    ...
    id: 7,
    title: "Поток идей / Kaizen Teian",
    description: "Включаем конвейер идей (Kaizen Teian). Каждый видит и предлагает улучшения — лучшие внедряются быстро.",
    steps: ["Одностраничная форма идеи и канал подачи", "Критерии отбора и быстрая приоритизация", "Недельные разборы и внедрение «на месте»", "Обратная связь и признание авторов"]
  }, {
    id: 8,
    title: "Визуальный менеджмент",
    description: "Делаем работу видимой. Статусы, метрики и проблемы видны всем — меньше совещаний, больше действий.",
    steps: ["Доски SQDC/ОЕЕ/сроки, WIP-лимиты", "Цветовая кодировка, маркеры статуса, Andon", "Дейли-брифинги у доски", "Ответственный за обновление и SLA данных"]
  }, {
    id: 9,
    title: "PDCA-циклы",
    description: "Работаем циклами PDCA. Тестируем малым, масштабируем сработавшее — учимся на данных.",
    steps: ["Гипотеза и метрика успеха", "Пилоты и сбор фактов", "Review: стандартизировать или менять подход", "Календарь экспериментов и A3-отчёты"]
  }, {
    id: 10,
    title: "Качество в процессе",
    description: "Встраиваем качество в процесс (TQM). Предотвращаем дефекты, а не исправляем — «правильно с первого раза».",
    steps: ["Определение CTQ (критично к качеству)", "Контроли в процессе и Poka-Yoke", "SPC-мониторинг и тренды", "План качества для поставщиков"]
  }, {
    id: 11,
    title: "Управление рисками",
    description: "Управляем рисками заранее. Ищем уязвимости и готовим сценарии реакции — устойчивость вместо сюрпризов.",
    steps: ["Реестр рисков и оценка вероятности/влияния", "FMEA критических операций", "Ранние триггеры и мониторинг", "Планы реагирования и учения"]
  }];
  useEffect(() => {
